...
maleGrade.reduce((acc,cv) => acc + cv.grade,0)/ maleGrade.length;
...
femaleGrade.reduce((acc , cv) => acc + cv.grade,0)/ femaleGrade.length;
...
let sortedArray = PeopleGrade.sort((a,b) => a-b);
