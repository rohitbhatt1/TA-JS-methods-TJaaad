...
let numbers = [1, 2, 3, 4, 5, 46, 7, 8, 90, 80, 45];
/*
...
let numbers = [3, 5, 6, 8, 9, 2, 4, 40, 90, 45];
...
let numbers = [1, 2, 3, 4, 5, 6, 7, 8, 89, 90, 75];
...
function changeArray(Array, cbf) {
  let finalArray = [];
  for (let num of Array) {
    finalArray.push(cbf(num));
  }
  return finalArray;
}
