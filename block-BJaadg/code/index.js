...
console.log(`The index of first is in quote is ${quote.charAt(indexOfI)}`);
...
quote.split('');
for(let i = 0; i < 6;i++){
  console.log(`the charcater of ${i} is '${quote[i]}'`)
  }
...
*/
console.log(quote.indexOf("a",40));
/*
...
let nueQuote = quote+".".repeat(max-length);
...
let newStartQuotes = ".".repeat(max-length) + quote;
/*
